...
<template>
  <LayoutProductShopping path="/product/cart-product" :opsiButton="2" headingBarName="Order Summary">
    ...
    <template #button-group>
      ...
      <ButtonAction data-test-id="confirm-order" :handlerEvent="confirmOrder" :disabled="nothingProductInCart" iconName="ReceiptItem" action="Confirm Order" />
    </template>
