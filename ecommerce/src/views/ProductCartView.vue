...
const nothingProductInCart = computed(() => quantityProducts.value?.length === 0);
...
<template>
  <LayoutProductShopping :opsiButton="1" headingBarName="Your Shopping Cart">
    ...
    <template #button-group>
      <ButtonAction data-test-id="buys-product" :handlerEvent="generateComfirmOrder" :disabled="nothingProductInCart" iconName="ReceiptItem" action="Buys" />
    </template>
